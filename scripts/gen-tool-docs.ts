...
function main(): void {
  ...
  const header = [
    ...
    `description: "Every tdmcp tool — the TouchDesigner MCP server exposes ${total} tools across three layers, library/packaging, AI session memory and an Obsidian vault, from one-line artist generators down to atomic node control."`,
    "---",
    "",
