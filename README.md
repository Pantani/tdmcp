...
For **simple tasks** you can talk to a **local LLM** instead of a paid API. `tdmcp chat`
(alias `tdmcp llm-run`) boots a small chat UI in your browser, wired to the same
